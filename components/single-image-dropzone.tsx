            ...
            <div>
                ...
                >
                    ...
                    {imageUrl && !disabled && (
                        ...
                        >
                            <div className="flex h-5 w-5 items-center justify-center rounded-md border border-solid border-white bg-white transition-all duration-300 hover:h-6 hover:w-6 dark:border-gray-500 dark:bg-black">
