  ...
  return (
    <div className="landing-page">
      ...
      <section className="hero-section">
        ...
        <div className="w-full overflow-hidden px-4 sm:px-6 lg:px-8 mt-8 mb-20">
          <div className="max-w-4xl mx-auto">
            <div className="rounded-xl overflow-hidden shadow-2xl border border-border/40">
              <img
                src="/screenshot.png"
                alt="AnyCowork Desktop App"
        ...
        <div className="hero-cta flex items-center justify-center gap-4 flex-wrap mb-0">
          <a href="/docs/getting-started" className="btn-primary btn-large">
            Get Started <ArrowRight size={20} />
          </a>
          <a href="https://github.com/AnyCowork/AnyCowork" className="btn-secondary btn-large flex items-center gap-2">
