...
- [Get started with Agent Skills](/docs/en/agents-and-tools/agent-skills/quickstart) - Create your first Skill
- [API Guide](/docs/en/build-with-claude/skills-guide) - Use Skills with the Claude API
- [Use Skills in Claude Code](https://code.claude.com/docs/en/skills) - Create and manage custom Skills in Claude Code
- [Use Skills in the Agent SDK](/docs/en/agent-sdk/skills) - Use Skills programmatically in TypeScript and Python
- [Authoring best practices](/docs/en/agents-and-tools/agent-skills/best-practices) - Write Skills that Claude can use effectively