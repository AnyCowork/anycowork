...
domains or tasks—they transform the AI from a general-purpose agent into a specialized agent
...
3. **Bundled resources** - As needed by the AI (Unlimited because scripts can be executed without reading into context window)
...
When the user chooses AWS, the AI only reads aws.md.
